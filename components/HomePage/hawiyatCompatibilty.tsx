  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10 py-12 lg:py-20">
        ...
        >
          <h1
            className={`text-3xl w-ull sm:text-5xl md:text-6xl lg:text-7xl font-semibold mb-6 lg:mb-8 text-white tracking-tight leading-tight transition-all duration-1200 ease-out ${
              textVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
            }`}
          >
            {['Hawiyat', 'is', 'the', 'Home', 'of', 'All', 'Apps.'].map((word, idx) => (
              <span
                key={idx}
                ...
                style={{ transitionDelay: textVisible ? `${idx * 100}ms` : '0ms' }}
              >
                {word}{idx < 6 ? ' ' : ''}
              </span>
            ))}
          ...
          <p
            className={`text-base sm:text-lg md:text-xl text-gray-400 max-w-4xl mx-auto font-normal leading-relaxed px-4 transition-all duration-1000 ease-out ${
              textVisible ? 'translate-y-0 opacity-100' : 'translate-y-6 opacity-0'
            }`}
            style={{ transitionDelay: textVisible ? '800ms' : '0ms' }}
          >
            Hawiyat is the all-in-one home where every application — from startup
            prototypes to enterprise-grade systems — is built, deployed, and scaled with
            power, simplicity, and intelligence.
          </p>
        </header>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          >
            <div className="flex justify-center mb-18">
              <div className="w-64 h-50" style={{ transform: `translateY(${Math.min(scrollY * 0.015, 20)}px)` }}>
                <Image src="/chat.png" alt="Deploy your AI agent" width={192} height={192} className="rounded-xl w-full h-full object-cover" priority />
              </div>
            </div>
            <div className="flex flex-col flex-grow justify-center text-start mt-auto">
              <h3 className="text-xl  sm:text-4xl font-semibold mb-4 text-white leading-tight">
                Deploy your AI agent
              </h3>
              <p className="text-gray-400 leading-relaxed text-sm sm:text-base">
                Deploy your AI agent instantly with Hawiyat for real-time user feedback
              </p>
            </div>
          </div>
          ...
          >
            <div className="flex justify-center mb-8">
              <div className="w-64 h-60" style={{ transform: `translateY(${Math.min(scrollY * 0.025, 20)}px)` }}>
                <Image src="/orbes.png" alt="Compatible with any framework" width={192} height={192} className="rounded-xl w-full h-full object-cover" priority />
              </div>
            </div>
            <div className="flex flex-col flex-grow justify-center text-start mt-auto">
              <h3 className="text-xl  sm:text-4xl font-semibold mb-4 text-white leading-tight">
              ...
              <p className="text-gray-400 leading-relaxed text-sm sm:text-base">
                React, Next.js, Vue, Nuxt, SvelteKit, and more—it runs on Hawiyat.
              </p>
            </div>
          </div>
          ...
          >
            <div className="flex justify-center mb-4">
              <div className="w-64 h-64" style={{ transform: `translateY(${Math.min(scrollY * 0.035, 20)}px)` }}>
                <Image src="/tech.png" alt="Deploy any complex app" width={192} height={192} className="rounded-xl w-full h-full object-cover" priority />
              </div>
            </div>
            <div className="flex flex-col flex-grow justify-center text-start mt-auto">
              <h3 className="text-xl  sm:text-4xl font-semibold mb-4 text-white leading-tight">
              ...
              <p className="text-gray-400 leading-relaxed text-sm sm:text-base">
                Our Managed Infrastructure enables you to spend more time building your product.
              </p>
            </div>
          </div>
