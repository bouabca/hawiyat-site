...
export const offersData: Offer[] = [
  ...
  },
  {
    ...
    features: ["1 vCore CPU", "2 GB RAM", "40 GB SSD", "Unlimited bandwidth", "1 Public IPv4", "Optional backups"],
    provider: "ADEX Cloud",
  },
  {
    title: "ADEX Cloud • M •",
    ...
    features: ["2 vCore CPU", "4 GB RAM", "80 GB SSD", "Unlimited bandwidth", "1 Public IPv4", "cPanel available"],
    provider: "ADEX Cloud",
  },
  {
    title: "ADEX Cloud • L •",
    ...
    features: ["4 vCore CPU", "8 GB RAM", "80 GB SSD", "Unlimited bandwidth", "1 Public IPv4", "Infogérance option"],
    provider: "ADEX Cloud",
  },
  {
    title: "ADEX Cloud • XL •",
    ...
    features: ["4 vCore CPU", "8 GB RAM", "150 GB SSD", "Unlimited bandwidth", "1 Public IPv4", "Daily snapshots"],
    provider: "ADEX Cloud",
  },
  {
    title: "ISSAL Net • ECO •",
    ...
    features: ["2 vCPU cores", "4 GB RAM", "100 GB disk", "Unlimited bandwidth", "1 Public IPv4", "SSH/RDP access"],
    provider: "ISSAL Net",
  },
  {
    ...
    features: ["4 vCPU cores", "6 GB RAM", "150 GB disk", "Unlimited bandwidth", "1 Public IPv4", "Automated backups"],
    provider: "ISSAL Net",
  },
  {
    ...
    features: ["6 vCPU cores", "8 GB RAM", "200 GB disk", "Unlimited bandwidth", "1 Public IPv4", "Priority support"],
    provider: "ISSAL Net",
  },
  {
    ...
    features: ["2 vCPU cores", "4 GB RAM", "100 GB disk", "Unlimited bandwidth", "1 Public IPv4", "99.9% SLA"],
    provider: "ISSAL Net",
  },
  {
    ...
    features: ["4 vCPU cores", "8 GB RAM", "150 GB disk", "Unlimited bandwidth", "1 Public IPv4", "Managed firewall"],
    provider: "ISSAL Net",
  },
  {
  ...
  },
  {
    ...
    features: ["1 vCPU", "2 GB RAM", "400 GB SSD", "Unlimited bandwidth", "1 Public IPv4", "Control panel"],
    provider: "Ayrade",
  },
  {
    title: "Ayrade • VPS 2 •",
    ...
    features: ["2 vCPU", "16 GB RAM", "400 GB SSD", "Unlimited bandwidth", "1 Public IPv4", "Daily backups"],
    provider: "Ayrade",
  },
  {
    title: "Ayrade • VPS 3 •",
    ...
    features: ["8 vCPU", "24 GB RAM", "1.2 TB SSD", "Unlimited bandwidth", "1 Public IPv4", "Premium support"],
    provider: "Ayrade",
  },
  {
    title: "Ayrade • VPS 4 •",
    ...
    features: ["12 vCPU", "48 GB RAM", "1.6 TB SSD", "Unlimited bandwidth", "1 Public IPv4", "Custom SLAs"],
    provider: "Ayrade",
  },
  {
    ...
    features: ["1 vCore CPU", "4 GB RAM", "80 GB SSD", "Unlimited bandwidth", "1 Public IPv4", "VMware virtualization"],
    provider: "Icosnet",
  },
  {
