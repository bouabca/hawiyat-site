...
function OfferCard({ offer }: { offer: Offer }) {
  ...
  return (
    <Card className="h-full flex flex-col p-6 rounded-3xl bg-gradient-to-tr from-[rgba(43,255,255,0.1)] via-[rgba(43,255,255,0.02)] to-[rgba(43,255,255,0.06)] text-white border border-[rgba(43,255,255,0.2)]">
      ...
      <div className="flex-shrink-0">
        <Button 
          ...
          className="w-full py-3 hover:cursor-pointer text-foreground border border-white/15 hover:bg-[rgba(255,255,255,0.08)] bg-gradient-to-b from-[rgba(255,255,255,0.08)] to-[rgba(255,255,255,0)] rounded-xl transition-all duration-200 font-medium"
        >
          Get Started
        </Button>
      </div>
